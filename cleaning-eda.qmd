...
```{r}
#| label: electrical missing values
ames |> 
    summarise(NAs = sum(is.na(electrical)))
```

There is one missing values that I impute using the mode.

```{r}
#| label: electrical impute
#| code-fold: true
ames <- ames |> 
...
```{r}
#| label: electrical frequency plot
#| echo: false
ames |> 
    nominal_frequency_bar(electrical,
                          order         = sale_price,
                          nominal_label = "Electrical",
...
```{r}
#| label: electrical vs sale_price
#| echo: false
ames |> 
    nominal_numeric_box(nominal       = electrical,
                        nominal_label = "Electrical",
                        numeric       = sale_price,
                        numeric_label = "Sale Price ($)",
...
```{r}
#| label: first_floor_area distribution
#| echo: false
ames |> 
    numeric_distribution(first_floor_area,
                         xlabel = "First Floor Area (ft2)",
                         title  = "First Floor Area Distribution")
```

### Summary Statistics

```{r}
#| label: first_floor_area summary statistics
#| echo: false
ames |>
    numeric_summary_table(first_floor_area)
```

### Relationship with Target Variable

```{r}
#| label: first_floor_area vs sale_price
#| echo: false
ames |>
    scatter_plot(x_numeric = first_floor_area,
                 y_numeric = sale_price,
                 x_label   = "First Floor Area (ft2)",
                 y_label   = "Sale Price ($)",
                 title     = "Sale Price vs First Floor Area")
```
...
```{r}
#| label: second_floor_area distribution
#| echo: false
ames |> 
    numeric_distribution(second_floor_area,
                         xlabel = "Second Floor Area (ft2)",
                         title  = "Second Floor Area Distribution")
```

### Summary Statistics

```{r}
#| label: second_floor_area summary statistics
#| echo: false
ames |>
    numeric_summary_table(second_floor_area)
```

### Relationship with Target Variable

```{r}
#| label: second_floor_area vs sale_price
#| echo: false
ames |>
    scatter_plot(x_numeric = second_floor_area,
                 y_numeric = sale_price,
                 x_label   = "Second Floor Area (ft2)",
                 y_label   = "Sale Price ($)",
                 title     = "Sale Price vs Second Floor Area")
```
...
```{r}
#| label: low_quality_finished_area distribution
#| echo: false
ames |> 
    numeric_distribution(low_quality_finished_area,
                         xlabel = "Low Quality Finished Area (ft2)",
                         title  = "Low Quality Finished Area Distribution")
```

### Summary Statistics

```{r}
#| label: low_quality_finished_area summary statistics
#| echo: false
ames |>
    numeric_summary_table(low_quality_finished_area)
```

### Relationship with Target Variable

```{r}
#| label: low_quality_finished_area vs sale_price
#| echo: false
ames |>
    scatter_plot(x_numeric = low_quality_finished_area,
                 y_numeric = sale_price,
                 x_label   = "Low Quality Finished Area (ft2)",
                 y_label   = "Sale Price ($)",
                 title     = "Sale Price vs Low Quality Finished Area")
```
...
```{r}
#| label: ground_living_area distribution
#| echo: false
ames |> 
    numeric_distribution(ground_living_area,
                         xlabel = "Ground Living Area (ft2)",
                         title  = "Ground Living Area Distribution")
```

### Summary Statistics

```{r}
#| label: ground_living_area summary statistics
#| echo: false
ames |>
    numeric_summary_table(ground_living_area)
```

### Relationship with Target Variable

```{r}
#| label: ground_living_area vs sale_price
#| echo: false
ames |>
    scatter_plot(x_numeric = ground_living_area,
                 y_numeric = sale_price,
                 x_label   = "Ground Living Area (ft2)",
                 y_label   = "Sale Price ($)",
...
```{r}
#| label: basement_full_bathrooms distribution
#| echo: false
ames |> 
    discrete_distribution(basement_full_bathrooms,
                          xlabel = "Basement Full Bathrooms",
                          title  = "Basement Full Bathrooms Distribution")
```

### Summary Statistics

```{r}
#| label: basement_full_bathrooms summary statistics
#| echo: false
ames |>
    numeric_summary_table(basement_full_bathrooms)
```

### Relationship with Target Variable

```{r}
#| label: basement_full_bathrooms vs sale_price
#| echo: false
ames |>
    scatter_plot(x_numeric = basement_full_bathrooms,
                 y_numeric = sale_price,
                 x_label   = "Basement Full Bathrooms",
                 y_label   = "Sale Price ($)",
                 title     = "Sale Price vs Basement Full Bathrooms")
```
...
```{r}
#| label: basement_half_bathrooms distribution
#| echo: false
ames |> 
    discrete_distribution(basement_half_bathrooms,
                          xlabel = "Basement Half Bathrooms",
                          title  = "Basement Half Bathrooms Distribution")
```

### Summary Statistics

```{r}
#| label: basement_half_bathrooms summary statistics
#| echo: false
ames |>
    numeric_summary_table(basement_half_bathrooms)
```

### Relationship with Target Variable

```{r}
#| label: basement_half_bathrooms vs sale_price
#| echo: false
ames |>
    scatter_plot(x_numeric = basement_half_bathrooms,
                 y_numeric = sale_price,
                 x_label   = "Basement Half Bathrooms",
                 y_label   = "Sale Price ($)",
                 title     = "Sale Price vs Basement Half Bathrooms")
```
...
```{r}
#| label: full_bathrooms distribution
#| echo: false
ames |> 
    discrete_distribution(full_bathrooms,
                          xlabel = "Full Bathrooms",
                          title  = "Full Bathrooms Distribution")
```

### Summary Statistics

```{r}
#| label: full_bathrooms summary statistics
#| echo: false
ames |>
    numeric_summary_table(full_bathrooms)
```

### Relationship with Target Variable

```{r}
#| label: full_bathrooms vs sale_price
#| echo: false
ames |>
    scatter_plot(x_numeric = full_bathrooms,
                 y_numeric = sale_price,
                 x_label   = "Full Bathrooms",
                 y_label   = "Sale Price ($)",
...
```{r}
#| label: half_bathrooms distribution
#| echo: false
ames |> 
    discrete_distribution(half_bathrooms,
                          xlabel = "Half Bathrooms",
                          title  = "Half Bathrooms Distribution")
```

### Summary Statistics

```{r}
#| label: half_bathrooms summary statistics
#| echo: false
ames |>
    numeric_summary_table(half_bathrooms)
```

### Relationship with Target Variable

```{r}
#| label: half_bathrooms vs sale_price
#| echo: false
ames |>
    scatter_plot(x_numeric = half_bathrooms,
                 y_numeric = sale_price,
                 x_label   = "Half Bathrooms",
                 y_label   = "Sale Price ($)",
                 title     = "Sale Price vs Half Bathrooms")
```
...
```{r}
#| label: bedroom_above_ground distribution
#| echo: false
ames |> 
    discrete_distribution(bedroom_above_ground,
                          xlabel = "Bedroom Above Ground",
                          title  = "Bedroom Above Ground Distribution")
```

### Summary Statistics

```{r}
#| label: bedroom_above_ground summary statistics
#| echo: false
ames |>
    numeric_summary_table(bedroom_above_ground)
```

### Relationship with Target Variable

```{r}
#| label: bedroom_above_ground vs sale_price
#| echo: false
ames |>
    scatter_plot(x_numeric = bedroom_above_ground,
                 y_numeric = sale_price,
                 x_label   = "Bedroom Above Ground",
                 y_label   = "Sale Price ($)",
                 title     = "Sale Price vs Bedroom Above Ground")
```
...
```{r}
#| label: kitchen_above_ground distribution
#| echo: false
ames |> 
    discrete_distribution(kitchen_above_ground,
                          xlabel = "Kitchen Above Ground",
                          title  = "Kitchen Above Ground Distribution")
```

### Summary Statistics

```{r}
#| label: kitchen_above_ground summary statistics
#| echo: false
ames |>
    numeric_summary_table(kitchen_above_ground)
```

### Relationship with Target Variable

```{r}
#| label: kitchen_above_ground vs sale_price
#| echo: false
ames |>
    scatter_plot(x_numeric = kitchen_above_ground,
                 y_numeric = sale_price,
                 x_label   = "Kitchen Above Ground",
                 y_label   = "Sale Price ($)",
                 title     = "Sale Price vs Kitchen Above Ground")
```
...
```{r}
#| label: kitchen_quality reconding
#| code-fold: true
ames <- ames |> 
...
```{r}
#| label: kitchen_quality frequency table
#| echo: false
ames |> 
    nominal_frequency_table(kitchen_quality)
```

### Frequency Plot

```{r}
#| label: kitchen_quality frequency plot
#| echo: false
ames |> 
    nominal_frequency_bar(kitchen_quality,
                          order         = sale_price,
                          nominal_label = "Kitchen Quality",
                          title         = "Kitchen Quality Distribution")
```

### Relationship with Target Variable

```{r}
#| label: kitchen_quality vs sale_price
#| echo: false
ames |> 
    nominal_numeric_box(nominal       = kitchen_quality,
                        nominal_label = "Kitchen Quality",
                        numeric       = sale_price,
                        numeric_label = "Sale Price ($)",
...
```{r}
#| label: total_rooms_above_ground distribution
#| echo: false
ames |> 
    discrete_distribution(total_rooms_above_ground,
                          xlabel = "Total Rooms Above Ground",
                          title  = "Total Rooms Above Ground Distribution")
```

### Summary Statistics

```{r}
#| label: total_rooms_above_ground summary statistics
#| echo: false
ames |>
    numeric_summary_table(total_rooms_above_ground)
```

### Relationship with Target Variable

```{r}
#| label: total_rooms_above_ground vs sale_price
#| echo: false
ames |>
    scatter_plot(x_numeric = total_rooms_above_ground,
                 y_numeric = sale_price,
                 x_label   = "Total Rooms Above Ground",
                 y_label   = "Sale Price ($)",
...
```{r}
#| label: functional frequency table
#| echo: false
ames |> 
    nominal_frequency_table(functional)
```

### Frequency Plot

```{r}
#| label: functional frequency plot
#| echo: false
ames |> 
    nominal_frequency_bar(functional,
                          order         = sale_price,
                          nominal_label = "Functional",
...
```{r}
#| label: functional vs sale_price
#| echo: false
ames |> 
    nominal_numeric_box(nominal       = functional,
                        nominal_label = "Functional",
                        numeric       = sale_price,
                        numeric_label = "Sale Price ($)",
                        title         = "Functional vs Sale Price")
```
...
```{r}
#| label: fireplaces distribution
#| echo: false
ames |> 
    discrete_distribution(fireplaces,
                          xlabel = "Fireplaces",
                          title  = "Fireplaces Distribution")
```

### Summary Statistics

```{r}
#| label: fireplaces summary statistics
#| echo: false
ames |>
    numeric_summary_table(fireplaces)
```

### Relationship with Target Variable

```{r}
#| label: fireplaces vs sale_price
#| echo: false
ames |>
    scatter_plot(x_numeric = fireplaces,
                 y_numeric = sale_price,
                 x_label   = "Fireplaces",
                 y_label   = "Sale Price ($)",
                 title     = "Sale Price vs Fireplaces")
```
...
```{r}
#| label: fireplace_quality missing values
ames |> 
    summarise(NAs = sum(is.na(fireplace_quality)))
```

Missing values happen when `fireplaces` is equal to zero.

```{r}
#| label: fireplace_quality missing values anaysis
ames |> 
    filter(is.na(fireplace_quality)) |> 
    count(fireplaces)
```

Therefore I impute the missing values with `No Fireplace`.

```{r}
#| label: fireplace_quality reconding
#| code-fold: true
ames <- ames |> 
...
```{r}
#| label: fireplace_quality frequency table
#| echo: false
ames |> 
    nominal_frequency_table(fireplace_quality)
```

### Frequency Plot

```{r}
#| label: fireplace_quality frequency plot
#| echo: false
ames |> 
    nominal_frequency_bar(fireplace_quality,
                          order         = sale_price,
                          nominal_label = "Fireplace Quality",
                          title         = "Fireplace Quality Distribution")
```

### Relationship with Target Variable

```{r}
#| label: fireplace_quality vs sale_price
#| echo: false
ames |> 
    nominal_numeric_box(nominal       = fireplace_quality,
                        nominal_label = "Fireplace Quality",
                        numeric       = sale_price,
                        numeric_label = "Sale Price ($)",
                        title         = "Fireplace Quality vs Sale Price")
```
